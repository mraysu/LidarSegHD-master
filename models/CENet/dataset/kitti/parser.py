...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
               ...
               percentLabels=None):        # number of points we want
    # save deats
  ...
  def __getitem__(self, index):
    ...
    if self.gt:
      scan = SemLaserScan(self.color_map,
                          ...
                          percentLabels=self.percentLabels)
    else:
...
class Parser():
  ...
  def __init__(self,
               ...
               percentLabels=0.1): # percentage of points
    ...
    self.train_dataset = SemanticKitti(root=self.root,
                                       ...
                                       sensor=self.sensor,
                                       max_points=int(max_points * self.percentLabels),
                                       transform=True,
                                       gt=self.gt,
                                       percentLabels=self.percentLabels)
